 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.3-service.soda"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.3-service.soda"
...
Return<bool> BiometricsFingerprint::isUdfps(uint32_t) {
    return false; // Back-mounted sensor (silead), not UDFPS
}
